const cards = [
    ...
    Card("Sorcerer",        4, castle,       B, Effect(onplay, :removebench, Selector(maxpower = 3))), # or lower
    ...
    Card("Illusionist",     6, funfair,      C, Effect(ongoing, :empty, requireflag = true)),
    ...
    Card("Rescue Pod",      1, outerspace,   A, Effect(onflagloss, :removebench, Selector(name = "Rescue Pod"))),
    Card("Shapeshifter",    2, outerspace,   A, ),
    ...
    Card("Cook",            2, shipwreck,    B, Effect(frombench, requireflag = true)), # card in flag possession
    Card("Lifeguard",       4, shipwreck,    B, Effect(ongoing, :deck, strength = 2)),
    Card("Navigator",       4, shipwreck,    B, ), #Effect(flagloss, :putundertop), # lookat
